...
class MaskPainter:
    ...
    def render(self) -> np.ndarray:
        ...
        status = f"Brush:{self.brush_size}px  Overlay:{self.opacity}%  Mask:{coverage:.1f}%"
...
def main() -> None:
    ...
    run_mask_painter(image_rgb=image_rgb, asset_name=args.asset_name, camera=args.camera)
